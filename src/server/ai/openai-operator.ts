...
export function buildOpenAiOperatorPayload(
  ...
  return {
    ...
    input: [
      ...
      "Return app actions only. Do not claim that changes were executed.",
      ...
      "Write document text as plain text, not Markdown. Do not use # headings, bullet markers, bold markers, code fences, or raw Markdown syntax in argsJson text/content.",
      "Mark calendar writes, deletion, bulk edits, and database restructuring with the correct risk level so the app can apply them locally with undo.",
